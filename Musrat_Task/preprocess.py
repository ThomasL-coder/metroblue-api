...
def build_features(df: pd.DataFrame):
    """
    Takes raw lead dataframe and returns:
    X = model features
    y = target
    """
    df = df.copy()
    ...
    # Basic booleans / numeric features
...
def transform_single_lead(lead_dict: dict, training_columns: list):
    """
    Transform one lead record into same feature shape used during training.
    """
